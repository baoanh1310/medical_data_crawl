# Scrapy settings for crawl_medical_data project
#
...
BOT_NAME = 'crawl_medical_data'

SPIDER_MODULES = ['crawl_medical_data.spiders']
NEWSPIDER_MODULE = 'crawl_medical_data.spiders'


# Crawl responsibly by identifying yourself (and your website) on the user-agent
#USER_AGENT = 'crawl_medical_data (+http://www.yourdomain.com)'
...
DOWNLOADER_MIDDLEWARES = {
    ...
    'crawl_medical_data.middlewares.RandomUserAgentMiddleware': 100,
    'crawl_medical_data.middlewares.ProxyMiddleware': 200,
    'crawl_medical_data.middlewares.RetryMiddleware': 820
}

ITEM_PIPELINES = {
    'crawl_medical_data.pipelines.MongoDBPipeline': 1,
}
