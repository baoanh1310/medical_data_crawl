...
new_df['drugPropertiesPercentage'] = df['nongDo']
new_df['apothecary'] = df['baoChe']
new_df['package'] = df['dongGoi']
...
new_df['productCompany'] = df['congTySx']
new_df['productCompanyCode'] = df['congTySxCode']
